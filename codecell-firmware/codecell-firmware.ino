...
bool removeGravity = false; // Toggle gravity removal - configurable via BLE (default: false for compatibility)
...
void setup() {
    ...
    // Initialize all motion sensors including magnetometer, linear acceleration, and gravity
